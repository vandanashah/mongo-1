...
class OntapKVIndex : public SortedDataInterface {
public:
# if 0
    /**
     ...
     */
    OntapKVIndex(OperationContext* ctx, const std::string& uri, const IndexDescriptor* desc);
...
#if 0
class OntapKVIndexUnique : public OntapKVIndex {
public:
    OntapKVIndexUnique(OperationContext* ctx,
...
class OntapKVIndexStandard : public OntapKVIndex {
public:
    OntapKVIndexStandard(OperationContext* ctx,
                            const std::string& uri,
                            const IndexDescriptor* desc);
