...
class OntapKVRecordStore : public RecordStore {
public:
    /**
    ...
    OntapKVRecordStore(OperationContext* txn,
                          StringData ns,
                          StringData uri,
...
/* Vandana: Confirm this are really not needed
...
//    virtual Status touch(OperationContext* txn, BSONObjBuilder* output) const;
    ...
    void setSizeStorer(OntapKVSizeStorer* ss) {
        _sizeStorer = ss;
    }
...
private:
    ...
    RecordData _getData(const OntapKVCursor& cursor) const;
    void _oplogSetStartHack(OntapKVRecoveryUnit* wru) const;
